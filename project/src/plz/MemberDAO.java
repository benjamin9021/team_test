...
public class MemberDAO {
	...
	public List<MemberDTO> list() {
		...
		try {
			...
			while (rs.next()) {
				list.add(new MemberDTO(rs.getString("id"), rs.getString("pw"), rs.getString("name"),rs.getString("birthday"),rs.getInt("nkey"),rs.getString("signupday")));
			}
	...
	public MemberDTO read(String id) {
		...
		try {
			...
			if (rs.next()) {
				dto = new MemberDTO(rs.getString("id"), rs.getString("pw"), rs.getString("name"),rs.getString("birthday"),rs.getInt("nkey"),rs.getString("signupday"));
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
